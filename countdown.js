...
// const endTime = new Date('2015-11-20 09:00:00');  //时间必须大于当前时间
var endTime = new Date()
endTime.setTime(endTime.getTime() + 3600*1000) //距离当前时间1小时后
var curShowTimeSeconds = 0 ;

var balls = [];
const colors = ["#33B5E5","#0099CC","#AA66CC","#99CC00","#669900","#FFBB33","#FF8800","#ff4444","#CC0000","#FFBBFF"];
...
function updateBalls(){
	...
	for(var i=0;i<balls.length;i++){
		if(balls[i].x + RADIUS > 0 && balls[i].x - RADIUS < WINDOW_WIDTH){
			// cnt ~ balls.length-1 之间的ball留在画布里 
			balls[cnt++] = balls[i]
		}
	}
...
/*总结
	...
	2.render 计算时间和点阵的关系
		renderDigit 点阵
	3.getCurrentShowTimeSeconds 获取时间
